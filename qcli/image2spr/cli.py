...
def main():
    ...
    parser.add_argument("-t", dest="type", default=0, help="sprite orientation type")
        ...
        try:
            while True:
                ...
                if local_transparency:
                    source_palette[
                        local_transparency * 3 : local_transparency * 3 + 3
                    ] = vgio.quake.palette[-1]

                if global_transparency and global_transparency != local_transparency:
                    source_palette[
                        global_transparency * 3 : global_transparency * 3 + 3
                    ] = vgio.quake.palette[-1]
